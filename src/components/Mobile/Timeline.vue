<template>
    <div class="content">
        ...
        <div class="detail-content" @click="closeMsg">
    ...
    export default {
        ...
        methods: {
            menu() {
                ...
                var obj = document.querySelector(".detail-content");
                var screenHeight = obj.offsetHeight;   //屏幕可见高度
                var scrollHeight = obj.scrollHeight;   //所有内容总高度
                this.scrollTop = document.querySelector(".detail-content").scrollTop;   //滚动条距离顶部高度
            ...
            getData(){
                if(!this.isLoading) {
                    this.isLoading = true;
                    var token = this.token ? this.token : 'dfc2f71eece25bcbc2997b984db9d0a7';
        ...
        mounted() {
            this.getData();
            var contentObj = document.querySelector(".detail-content");
