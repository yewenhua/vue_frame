    ...
    export default {
        ...
        data() {
            let option = {
                ...
                colors: ['#90ed7d', '#7cb5ec', '#e9d26d', '#f6393f'],
                series: [{
                    name: '普通消息',
                    data: []
                }, {
        ...
        methods: {
            getData(){
                ...
                if(!this.isLoading) {
                    ...
                    this.hasData = false;
                    this.graph = graph;
                    var url = this.axios.defaults.baseURL + '/message/list?access_token=d9b7727e63bfc254e32d07a96ff71ff5';
                    this.axios({
                        method: 'post',
                        url: url,
                        data: {
